...
class Navtex(BaseCall):
    ...
    This class is not intended to be created or used directly, but rather utilized under the pyfldm client object. Reference client.py which has an attribute self.navtex that interfaces these methods.
