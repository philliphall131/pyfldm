...
#TODO: abstract to a higher level
...
class TestingRunner:
    ...
    def _init_loggers(self):
        testing_logger = logging.getLogger('radio_tests')
    ...
    def get_file_name(self):
        return datetime.now().strftime('%Y%m%d_%H%M%S_radio_test_result.log')
    ...
    def _clean_log_file(self):
        #TODO: instead of swapping files, read into a buffer and re-write the file
